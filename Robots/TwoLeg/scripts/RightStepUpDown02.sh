...
2,MotorAccel(MOTOR_LEFT_SIDE,6,3000,ACCEL_LEFT_LOWER_LEG,Z,-4,-4,1,ACCEL_TORSO,Z,-1,-3,1,WAIT_STAGE|CONSTANT_THRUST|MAX_THRUST=9|ABORT_ON_TIMEOUT)
...
#Stage 4: LOWER RIGHT LEG, left side holds right leg off the ground 
...
4,MotorAccel(MOTOR_RIGHT_KNEE,10,1000,ACCEL_RIGHT_LOWER_LEG,X,RLLX0,-1,1,WAIT_STAGE|CONSTANT_THRUST|HOLD_ANGLE)
