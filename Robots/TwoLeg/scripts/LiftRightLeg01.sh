...
2,MotorAccel(MOTOR_LEFT_ANKLE,3,2000,ACCEL_LEFT_FOOT,Z,0,-10,10,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=14|MAX_REVERSE_THRUST=14|MAX_VELOCITY=5|FUTURE_LOG|ABORT_ANGLE0=15|MAINTAIN_THRUST)
#legs hold up torso
