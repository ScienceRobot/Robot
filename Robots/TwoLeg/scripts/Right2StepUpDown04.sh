#Right2StepUpDown04.sh
#Calibrated for LEG Z = +-5
...
#HOLD_ANGLE=1:0.5
3,MotorAccel(MOTOR_LEFT_KNEE,14,400,ACCEL_LEFT_UPPER_LEG,X,LULX0,-2,2,WAIT_STAGE|MAX_THRUST=14|MAX_REVERSE_THRUST=6|MAX_ACCEL=1|MIN_VELOCITY=10|MAX_VELOCITY=20|MAINTAIN_THRUST|ABORT_ANGLE0=25)
...
3,MotorAccel(MOTOR_LEFT_ANKLE,12,400,ACCEL_LEFT_UPPER_LEG,Z,-2.5,-0.5,0.5,ACCEL_LEFT_LOWER_LEG,Z,0,-7,5,ACCEL_LEFT_FOOT,Z,0,-3,3,WAIT_STAGE|TVR=10.0:3.0:8|MAX_THRUST0=12|MAX_THRUST1=5|MAX_REVERSE_THRUST=7|MIN_VELOCITY=5|MAX_VELOCITY=8|MAX_ACCEL=3|ABORT_ANGLE0=30|OPPOSE_MOTION_IN_RANGE_MOVING_TO_TARGET|MAINTAIN_THRUST|IF_NOT_A1_MAXTHRUST=9|IF_NOT_A2_MAXTHRUST=5|FUTURE_LOG)
...
3,MotorAccel(MOTOR_TORSO,3,400,ACCEL_TORSO,X,TX0,-1,1,WAIT_STAGE|TVR=0.5:4:3|MAX_THRUST=11|MAX_REVERSE_THRUST=3|MIN_VELOCITY=5|MAX_VELOCITY=10|MAX_ACCEL=5|NO_MOTION_NO_THRUST|NO_STOP_ON_TARGET|MAINTAIN_THRUST)
...
4,MotorAccel(MOTOR_LEFT_LEG,8,1000,ACCEL_HIP,X,0,-1,1,WAIT_STAGE|MAX_THRUST=9|MAX_REVERSE_THRUST=3|TVR=0.3:4:4)
...
4,MotorAccel(MOTOR_LEFT_SIDE,13,1000,ACCEL_TORSO,Z,-6,-1,1,ACCEL_TORSO,Z,6,-1,1,ACCEL_RIGHT_UPPER_LEG,Z,2,-20,0,ACCEL_RIGHT_UPPER_LEG,X,22,0,75,WAIT_STAGE|TVR0=20:4:8|MAX_THRUST0=13|MAX_THRUST1=8|MAX_REVERSE_THRUST=2|MAX_ACCEL0=10|MIN_VELOCITY0=20|MAX_VELOCITY0=30|MAX_ACCEL1=10|MIN_VELOCITY1=10|MAX_VELOCITY1=20|MAINTAIN_THRUST|IF_A2_AND_A3|VELOCITY_A3_OR>-10|FUTURE_LOG)
...
4,MotorAccel(MOTOR_TORSO,3,1000,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|TVR=0.5:4:3|MAX_THRUST=12|MAX_REVERSE_THRUST=2|MIN_VELOCITY=5|MAX_VELOCITY=10|MAX_ACCEL=5|MAINTAIN_THRUST|FUTURE_LOG)
...
5,MotorAccel(MOTOR_RIGHT_KNEE,14,1500,ACCEL_RIGHT_UPPER_LEG,X,24,-4,4,ACCEL_RIGHT_LOWER_LEG,X,0,0,0,WAIT_STAGE|TVR=2:0.5:5|MAX_THRUST0=14|MAX_REVERSE_THRUST0=6|MAX_ACCEL0=10|MIN_VELOCITY0=20|MAX_VELOCITY0=40|ABORT_ANGLE0=40|MAINTAIN_THRUST|NO_MOTION_NO_THRUST|RELATIVE_ANGLE0|REQUIRED|FUTURE_LOG)
#
5,MotorAccel(MOTOR_LEFT_KNEE,10,1500,ACCEL_LEFT_UPPER_LEG,X,24,-3,3,ACCEL_LEFT_LOWER_LEG,X,0,0,0,ACCEL_HIP,X,0,-3,3,WAIT_STAGE|TVR=2:0.5:5|MAX_THRUST0=10|MAX_REVERSE_THRUST0=6|MIN_VELOCITY0=20|MAX_VELOCITY0=30|MAX_ACCEL0=1|MAX_THRUST1=10|MAX_REVERSE_THRUST1=6|MAX_VELOCITY1=30|MAX_ACCEL1=0.5|MAX_THRUST2=10|MAX_REVERSE_THRUST2=6|MAX_VELOCITY2=30|MAX_ACCEL2=0.5|FARTHEST_FROM_TARGET|NO_MOTION_NO_THRUST|RELATIVE_ANGLE0|FUTURE_LOG)
...
#OPPOSE_MOTION_IN_RANGE_MOVING_TO_TARGET|
5,MotorAccel(MOTOR_TORSO,3,1500,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|TVR=0.4:2:3|MAX_THRUST=9|MAX_REVERSE_THRUST=2|MIN_VELOCITY=5|MAX_VELOCITY=10|MAX_ACCEL=5|NO_MOTION_NO_THRUST|FUTURE_LOG)
...
#OPPOSE_MOTION_IN_RANGE_MOVING_TO_TARGET|
6,MotorAccel(MOTOR_TORSO,3,1000,ACCEL_TORSO,X,TX0,-1,1,WAIT_STAGE|TVR=0.2:0.2:3|MAX_THRUST=6|MAX_REVERSE_THRUST=5|MIN_VELOCITY=5|MAX_VELOCITY=10|MAX_ACCEL=5|MAINTAIN_THRUST|NO_MOTION_NO_THRUST|FUTURE_LOG)
#possibly right leg motor needs to hold up leg or possibly falls down
...
7,MotorAccel(MOTOR_RIGHT_LEG,14,400,ACCEL_LEFT_UPPER_LEG,X,20,-1,5,WAIT_STAGE|CONSTANT_THRUST)
...
7,MotorAccel(MOTOR_RIGHT_ANKLE,12,400,ACCEL_RIGHT_UPPER_LEG,Z,2.5,-0.5,0.5,ACCEL_RIGHT_LOWER_LEG,Z,0,-7,5,ACCEL_RIGHT_FOOT,Z,0,-3,3,WAIT_STAGE|TVR=10.0:3.0:8|MAX_THRUST0=12|MAX_THRUST1=5|MAX_REVERSE_THRUST=7|MIN_VELOCITY=5|MAX_VELOCITY=8|MAX_ACCEL=3|ABORT_ANGLE0=30|OPPOSE_MOTION_IN_RANGE_MOVING_TO_TARGET|MAINTAIN_THRUST|IF_NOT_A1_MAXTHRUST=9|IF_NOT_A2_MAXTHRUST=5|FUTURE_LOG)
