...
0,MotorAccel(MOTOR_LEFT_SIDE,2,5000,ACCEL_LEFT_UPPER_LEG,Z,6,-0.5,0.5,WAIT_STAGE,DOUBLE_THRUST|MOTION_LOG|FUTURE_LOG|HOLD_ANGLE)
0,MotorAccel(MOTOR_RIGHT_SIDE,2,5000,ACCEL_LEFT_UPPER_LEG,Z,6,-0.5,0.5,WAIT_STAGE,DOUBLE_THRUST|HOLD_ANGLE)
