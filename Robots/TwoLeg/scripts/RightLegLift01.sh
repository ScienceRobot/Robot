...
#stage 2: Get torso Z to straighten, and put torso weight over left leg
#2,MotorAccel(MOTOR_LEFT_SIDE,9,2000,ACCEL_TORSO,Z,0,-1,1,WAIT_STAGE|MAX_THRUST=6)
#2,MotorAccel(MOTOR_LEFT_ANKLE,3,5000,ACCEL_LEFT_FOOT,Z,0,-1,1,ACCEL_LEFT_LOWER_LEG,Z,-3,-1,1,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=3)
...
#alternatively have left side hold left upper leg (note that these motor directions are reversed)
3,MotorAccel(MOTOR_LEFT_SIDE,9,2000,ACCEL_LEFT_UPPER_LEG,Z,CurrentAngle,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=10)
