...
#side motors
0,HoldAngleWithMotor(ACCEL_TORSO,Z,-5,-3,0,MOTOR_LEFT_SIDE,10,2000,WAIT_STAGE)
0,HoldAngleWithMotor(ACCEL_TORSO,Z,-5,-3,0,MOTOR_RIGHT_SIDE,10,2000,WAIT_STAGE)
