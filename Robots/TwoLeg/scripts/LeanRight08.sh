...
0,MotorAccel(MOTOR_LEFT_SIDE,MOTOR_RIGHT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,6,-1,1,WAIT_STAGE|DOUBLE_THRUST|FUTURE_LOG|MIN_VELOCITY=3|MAX_VELOCITY=4)
0,MotorAccel(MOTOR_LEFT_ANKLE,MOTOR_RIGHT_ANKLE,4,5000,ACCEL_LEFT_LOWER_LEG,Z,6,-1,1,WAIT_STAGE|DOUBLE_THRUST|FUTURE_LOG|MIN_VELOCITY=3|MAX_VELOCITY=4)
