...
#Stage 4: LOWER RIGHT LEG
4,MotorAccel(MOTOR_RIGHT_LEG,6,500,ACCEL_RIGHT_UPPER_LEG,X,RULX0_BeforeLift,-0.5,0.5,WAIT_STAGE|CONSTANT_THRUST)
4,MotorAccel(MOTOR_RIGHT_KNEE,9,500,ACCEL_RIGHT_LOWER_LEG,X,RLLX0_BeforeLift,-0.5,0.5,WAIT_STAGE|CONSTANT_THRUST|HOLD_ANGLE)
