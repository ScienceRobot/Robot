...
#note that at least a 2 degree range is best to make sure the brake does not reach V=0 before the target zone.
1,MotorAccel(MOTOR_LEFT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,-7.5,-1,1,WAIT_STAGE|DOUBLE_THRUST|MAX_VELOCITY=10|MIN_VELOCITY=5|MAX_THRUST=3|MAX_REVERSE_THRUST=8)
1,MotorAccel(MOTOR_RIGHT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,-7.5,-1,1,WAIT_STAGE|HOLD_ANGLE|DOUBLE_THRUST|MAX_VELOCITY=10|MIN_VELOCITY=5|MAX_THRUST=3|MAX_REVERSE_THRUST=8)
#maxv=10 minv=5
1,MotorAccel(MOTOR_LEFT_ANKLE,2,5000,ACCEL_LEFT_FOOT,Z,0,-10,5,ACCEL_LEFT_LOWER_LEG,Z,-8,-1,0.5,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=3|MAX_REVERSE_THRUST=8|MAX_VELOCITY=11|MIN_VELOCITY=7|FUTURE_LOG|MAINTAIN_THRUST)
1,MotorAccel(MOTOR_RIGHT_ANKLE,2,5000,ACCEL_RIGHT_FOOT,Z,0,-10,5,ACCEL_LEFT_LOWER_LEG,Z,-8,-1,0.5,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=3|MAX_REVERSE_THRUST=8|MAX_VELOCITY=11|MIN_VELOCITY=7)
...
3,MotorAccel(MOTOR_RIGHT_KNEE,18,600,ACCEL_RIGHT_LOWER_LEG,X,-20,-1,1,WAIT_STAGE|CONSTANT_THRUST|HOLD_ANGLE)
...
3,MotorAccel(MOTOR_LEFT_ANKLE,12,600,ACCEL_LEFT_LOWER_LEG,Z,-8,-2,0,WAIT_STAGE|HOLD_ANGLE=10.0:1.0|MAX_THRUST=20|MAX_REVERSE_THRUST=2|MAX_VELOCITY=5|MAINTAIN_THRUST|ABORT_ANGLE0=20|FUTURE_LOG)
...
3,MotorAccel(MOTOR_LEFT_SIDE,20,600,ACCEL_TORSO,Z,-4,-5,0,ACCEL_RIGHT_UPPER_LEG,Z,-12,-1,0,WAIT_STAGE|HOLD_ANGLE=10:0|MAX_THRUST=20|MAX_REVERSE_THRUST=2|MAX_VELOCITY=20|MAINTAIN_THRUST|FUTURE_LOG)
...
#Stage 4: LOWER RIGHT LEG SWINGS FORWARD, UPPER LEG COMES BACK DOWN, left side holds right leg off the ground 
#right knee swings forward 
4,MotorAccel(MOTOR_RIGHT_KNEE,18,800,ACCEL_RIGHT_LOWER_LEG,X,RLLX0,-1,1,WAIT_STAGE|CONSTANT_THRUST|ABORT_ANGLE0=-30)
...
4,MotorAccel(MOTOR_LEFT_ANKLE,3,800,ACCEL_LEFT_FOOT,Z,0,-5,5,ACCEL_LEFT_LOWER_LEG,Z,-7.5,-1,1,WAIT_STAGE|HOLD_ANGLE=20:1|MAX_THRUST=20|MAX_REVERSE_THRUST=2|ABORT_ANGLE0=20|MAINTAIN_THRUST)
...
4,MotorAccel(MOTOR_LEFT_SIDE,6,800,ACCEL_TORSO,Z,-4,-5,1,ACCEL_RIGHT_UPPER_LEG,Z,-12,-1,0,WAIT_STAGE|HOLD_ANGLE=10:0|MAX_THRUST=20|MAX_REVERSE_THRUST=2|MAINTAIN_THRUST|FUTURE_LOG)
...
#4,MotorAccel(MOTOR_LEFT_LEG,14,800,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=18|MAX_REVERSE_THRUST=3|MAX_VELOCITY=20)
4,MotorAccel(MOTOR_LEFT_LEG,14,800,ACCEL_RIGHT_UPPER_LEG,X,RULX0,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=18|MAX_REVERSE_THRUST=3|CONSTANT_THRUST)
...
#***note no HOLD_ANGLE***
4,MotorAccel(MOTOR_RIGHT_LEG,14,800,ACCEL_RIGHT_UPPER_LEG,X,RULX0,-1,1,WAIT_STAGE|CONSTANT_THRUST)
...
4,MotorAccel(MOTOR_LEFT_FOOT,10,800,ACCEL_LEFT_FOOT,X,0,-5,5,ACCEL_HIP,X,0,-1,1,WAIT_STAGE|HOLD_ANGLE=0.5:2|MAX_THRUST=16|MAX_REVERSE_THRUST=3|MAX_VELOCITY=20)
...
4,MotorAccel(MOTOR_LEFT_KNEE,10,800,ACCEL_TORSO,Z,-4,-2,2,ACCEL_LEFT_UPPER_LEG,X,LULX0,-2,2,WAIT_STAGE|HOLD_ANGLE=0.3:0.1|MAX_THRUST=12|MAX_REVERSE_THRUST=6|MAINTAIN_THRUST|ABORT_ANGLE0=30)
#bias for pos
