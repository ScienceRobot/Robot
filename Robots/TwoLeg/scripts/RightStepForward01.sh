...
1,MotorAccel(MOTOR_TORSO,3,5000,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=4|MAX_REVERSE_THRUST=3|MAX_VELOCITY=20|MAINTAIN_THRUST)
...
2,MotorAccel(MOTOR_LEFT_SIDE,9,3000,ACCEL_LEFT_LOWER_LEG,Z,-4,-4,1,ACCEL_TORSO,Z,-2,-3,1,WAIT_STAGE|CONSTANT_THRUST|MAX_THRUST=9|ABORT_ON_TIMEOUT)
#ABORT_ANGLE0=5 - end script if ankle Z turns past 5 degrees was -6
2,MotorAccel(MOTOR_LEFT_ANKLE,3,10000,ACCEL_LEFT_FOOT,Z,0,-10,10,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,2,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=12|MAX_REVERSE_THRUST=3|ABORT_ANGLE0=15)
#legs hold up torso
...
2,MotorAccel(MOTOR_RIGHT_KNEE,3,3000,ACCEL_RIGHT_UPPER_LEG,X,CurrentAngle,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=8)
...
2,MotorAccel(MOTOR_TORSO,3,10000,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=4|MAX_REVERSE_THRUST=3|MAINTAIN_THRUST|MAX_VELOCITY=20)
...
3,MotorAccel(MOTOR_LEFT_ANKLE,12,10000,ACCEL_LEFT_FOOT,Z,0,-10,10,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,1,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=12|MAX_REVERSE_THRUST=3|ABORT_ANGLE0=15|LAST_STAGE=4)
#important that left knee hold ULX to 17 standing is 10 - left knee needs to push hard initially
3,MotorAccel(MOTOR_LEFT_SIDE,6,10000,ACCEL_LEFT_LOWER_LEG,Z,-5,-1,1,ACCEL_TORSO,Z,-2,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=9|MAX_REVERSE_THRUST=2|LAST_STAGE=4)
#right side pushes away from left leg
3,MotorAccel(MOTOR_RIGHT_SIDE,6,10000,ACCEL_RIGHT_LOWER_LEG,Z,CurrentAngle,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=5|MAX_REVERSE_THRUST=2|LAST_STAGE=4)
...
3,MotorAccel(MOTOR_TORSO,3,10000,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=4|MAX_REVERSE_THRUST=3|MAINTAIN_THRUST|MAX_VELOCITY=20)


#Stage 4: LOWER RIGHT LEG SWINGS FORWARD, left side holds right leg off the ground 
#4,MotorAccel(MOTOR_RIGHT_LEG,8,1000,ACCEL_RIGHT_UPPER_LEG,X,RULX0,-1,1,WAIT_STAGE|CONSTANT_THRUST)
#4,MotorAccel(MOTOR_LEFT_LEG,8,1000,ACCEL_RIGHT_UPPER_LEG,X,LULX0,-1,1,WAIT_STAGE|CONSTANT_THRUST|HOLD_ANGLE)
#right knee swings forward todo: change to absolute angle 6-10deg
4,MotorAccel(MOTOR_RIGHT_KNEE,12,1000,ACCEL_RIGHT_LOWER_LEG,X,-10,-1,1,WAIT_STAGE|CONSTANT_THRUST)
#4,MotorAccel(MOTOR_LEFT_KNEE,9,400,ACCEL_LEFT_UPPER_LEG,X,LULX0,-1,1,WAIT_STAGE|CONSTANT_THRUST|HOLD_ANGLE)
#4,MotorAccel(MOTOR_LEFT_FOOT,5,400,ACCEL_LEFT_FOOT,X,0,-2,2,ACCEL_LEFT_LOWER_LEG,X,LLLX0,-1,1,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|ABORT_ANGLE1=-30)
#sides return to original angle
#4,MotorAccel(MOTOR_LEFT_SIDE,3,3000,ACCEL_LEFT_LOWER_LEG,Z,LLLZ0,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=8|MAX_REVERSE_THRUST=3|DOUBLE_THRUST)
#4,MotorAccel(MOTOR_RIGHT_SIDE,3,3000,ACCEL_RIGHT_LOWER_LEG,Z,RLLZ0,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=8|MAX_REVERSE_THRUST=3|DOUBLE_THRUST)
...
4,MotorAccel(MOTOR_TORSO,3,10000,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=4|MAX_REVERSE_THRUST=3|MAINTAIN_THRUST|MAX_VELOCITY=20)
...
#left ankle can go back to the original angle
5,MotorAccel(MOTOR_LEFT_ANKLE,3,3000,ACCEL_LEFT_FOOT,Z,0,-10,10,ACCEL_LEFT_LOWER_LEG,Z,LLLZ0,-1,1,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=12|MAX_REVERSE_THRUST=3|ABORT_ANGLE0=15)
5,MotorAccel(MOTOR_RIGHT_ANKLE,3,3000,ACCEL_RIGHT_FOOT,Z,0,-10,10,ACCEL_RIGHT_LOWER_LEG,Z,RLLZ0,-1,1,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=12|MAX_REVERSE_THRUST=3|ABORT_ANGLE0=15)
...
5,MotorAccel(MOTOR_RIGHT_FOOT,5,3000,ACCEL_RIGHT_FOOT,X,0,-2,2,ACCEL_RIGHT_LOWER_LEG,X,RLLX0,-1,1,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG)
5,MotorAccel(MOTOR_TORSO,3,10000,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE|FUTURE_LOG|MAX_THRUST=4|MAX_REVERSE_THRUST=3|MAX_VELOCITY=20)
