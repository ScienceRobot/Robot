...
1,MotorAccel(MOTOR_LEFT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,0.5,WAIT_STAGE|DOUBLE_THRUST|MAX_VELOCITY=12|MIN_VELOCITY=5|MAX_THRUST=3|MAX_REVERSE_THRUST=3)
1,MotorAccel(MOTOR_RIGHT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,0.5,WAIT_STAGE|HOLD_ANGLE|DOUBLE_THRUST|MAX_VELOCITY=12|MIN_VELOCITY=5|MAX_THRUST=3|MAX_REVERSE_THRUST=3)
#maxv=10 minv=5
1,MotorAccel(MOTOR_LEFT_ANKLE,3,5000,ACCEL_LEFT_FOOT,Z,0,-10,5,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,0.5,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=3|MAX_REVERSE_THRUST=5|MAX_VELOCITY=10|MIN_VELOCITY=7|FUTURE_LOG|MAINTAIN_THRUST)
1,MotorAccel(MOTOR_RIGHT_ANKLE,3,5000,ACCEL_RIGHT_FOOT,Z,0,-10,5,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,0.5,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=3|MAX_REVERSE_THRUST=5|MAX_VELOCITY=10|MIN_VELOCITY=7)
...
2,MotorAccel(MOTOR_LEFT_SIDE,7,4000,ACCEL_LEFT_LOWER_LEG,Z,-4,-2,2,ACCEL_TORSO,Z,-6,-5,3,WAIT_STAGE|MAX_THRUST=12|ABORT_ON_TIMEOUT|MAX_VELOCITY=30|MIN_VELOCITY=10|FUTURE_LOG)
...
2,MotorAccel(MOTOR_LEFT_ANKLE,3,4000,ACCEL_LEFT_FOOT,Z,0,-20,10,ACCEL_LEFT_LOWER_LEG,Z,-4,-1,0,WAIT_STAGE|HOLD_ANGLE=10.0:1.0|MAX_THRUST=20|MAX_REVERSE_THRUST=4|MIN_VELOCITY=7|MAX_VELOCITY=10|ABORT_ANGLE0=30|MAINTAIN_THRUST|FUTURE_LOG)
#legs hold up torso
...
3,MotorAccel(MOTOR_RIGHT_LEG,16,600,ACCEL_RIGHT_UPPER_LEG,X,20,-1,5,WAIT_STAGE|CONSTANT_THRUST)
...
3,MotorAccel(MOTOR_LEFT_KNEE,10,600,ACCEL_TORSO,Z,-4,-1,1,WAIT_STAGE|HOLD_ANGLE=1:0.5|MAX_THRUST=16|MAX_REVERSE_THRUST=4|MAINTAIN_THRUST|ABORT_ANGLE0=25)
...
3,MotorAccel(MOTOR_LEFT_FOOT,5,600,ACCEL_LEFT_FOOT,X,0,-2,2,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE=2:0.5|ABORT_ANGLE1=-30|MAX_THRUST=16|MAX_REVERSE_THRUST=3|MAX_VELOCITY=20)
...
5,MotorAccel(MOTOR_LEFT_SIDE,3,3000,ACCEL_TORSO,Z,TZ0,-2,2,ACCEL_LEFT_LOWER_LEG,Z,LLLZ0,-2,2,WAIT_STAGE|HOLD_ANGLE=0.5:0.5|MAX_THRUST=18|MAX_REVERSE_THRUST=3)
5,MotorAccel(MOTOR_RIGHT_SIDE,3,3000,ACCEL_TORSO,Z,TZ0,-2,2,ACCEL_RIGHT_LOWER_LEG,Z,RLLZ0,-2,2,WAIT_STAGE|HOLD_ANGLE=0.5:0.5|MAX_THRUST=18|MAX_REVERSE_THRUST=3)
...
5,MotorAccel(MOTOR_RIGHT_KNEE,16,3000,ACCEL_TORSO,Z,0,-2,2,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE=0.5:0.5|MAX_THRUST=8|MAX_VELOCITY=20|ABORT_ANGLE0=40)
...
5,MotorAccel(MOTOR_TORSO,3,3000,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE=0.5:0.5|MAX_THRUST=8|MAX_REVERSE_THRUST=2|MAX_VELOCITY=10)
