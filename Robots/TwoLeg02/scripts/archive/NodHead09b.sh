...
#0,HoldAngleWithMotor(ACCEL_HEAD,X,-15,0,15,MOTOR_HEAD,3,5000,WAIT_STAGE|MOTION_LOG|CONSTANT_THRUST)
#0,MotorAccel(MOTOR_HEAD,3,5000,ACCEL_HEAD,X,-15,0,15,WAIT_STAGE|MOTION_LOG|CONSTANT_THRUST|HOLD_ANGLE)
#0,MotorAccel(MOTOR_HEAD,3,5000,ACCEL_HEAD,X,-15,-2,2,WAIT_STAGE|MOTION_LOG|FUTURE_LOG|HOLD_ANGLE)
0,MotorAccel(MOTOR_HEAD,12,5000,ACCEL_HEAD,X,-15,-2,2,MOTION_LOG|FUTURE_LOG)
