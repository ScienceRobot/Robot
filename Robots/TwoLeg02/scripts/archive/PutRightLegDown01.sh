#PutRightLegDown01.sh 
0,StartLogging  
1,TurnMotor(ETHMOTORS_LOWER_BODY,MOTOR_RIGHT_KNEE,-2,400) 
1,TurnMotor(ETHMOTORS_LOWER_BODY,MOTOR_RIGHT_LEG,-2,400)
1,TurnMotor(ETHMOTORS_LOWER_BODY,MOTOR_LEFT_LEG,2,400)
