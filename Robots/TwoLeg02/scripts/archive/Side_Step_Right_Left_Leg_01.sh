#Side_Step_Right_Left_Leg_01.sh
0,StartLogging
...
200,TurnMotor(ETHMOTORS_LOWER_BODY,MOTOR_LEFT_SIDE,6,400)
600,TurnMotor(ETHMOTORS_LOWER_BODY,MOTOR_LEFT_KNEE,6,300) 
600,TurnMotor(ETHMOTORS_LOWER_BODY,MOTOR_LEFT_LEG,6,300)
