...
#0,HoldAngleWithMotor(ETHACCELS_TORSO,0,2,2,-2,2,ETHMOTORS_LOWER_BODY,MOTOR_LEFT_SIDE,5000,WAIT_STAGE)
#right lower leg z 
#lower right leg Z of -9.0 is accurate for leaning left
#w/o braking -8,-1,1
#0,HoldAngleWithMotor(ETHACCELS_TORSO,0,2,2,-2,2,ETHMOTORS_LOWER_BODY,MOTOR_RIGHT_SIDE,5000,WAIT_STAGE)
500,StopLogging
