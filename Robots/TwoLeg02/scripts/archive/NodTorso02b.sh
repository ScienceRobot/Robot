...
0,MotorAccel(MOTOR_LEFT_LEG,1,3000,ACCEL_TORSO,X,-6,-1,1,WAIT_STAGE|MOTION_LOG|DOUBLE_THRUST|FUTURE_LOG|HOLD_ANGLE)
0,MotorAccel(MOTOR_RIGHT_LEG,1,3000,ACCEL_TORSO,X,-6,-1,1,WAIT_STAGE|DOUBLE_THRUST|HOLD_ANGLE)
