...
0,HoldAngleWithMotor(ACCEL_TORSO,X,-15,-10,0,MOTOR_LEFT_LEG,3,5000,WAIT_STAGE|MOTION_LOG|DOUBLE_THRUST|CONSTANT_THRUST)
0,HoldAngleWithMotor(ACCEL_TORSO,X,-15,-10,0,MOTOR_RIGHT_LEG,3,5000,WAIT_STAGE|DOUBLE_THRUST|CONSTANT_THRUST)
