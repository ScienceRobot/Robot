...
1,MotorAccel(MOTOR_LEFT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,-8,-1,0.5,WAIT_STAGE|DOUBLE_THRUST|MAX_VELOCITY=12|MIN_VELOCITY=5|MAX_THRUST=3|MAX_REVERSE_THRUST=4)
1,MotorAccel(MOTOR_RIGHT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,-8,-1,0.5,WAIT_STAGE|HOLD_ANGLE|DOUBLE_THRUST|MAX_VELOCITY=12|MIN_VELOCITY=5|MAX_THRUST=3|MAX_REVERSE_THRUST=4)
#maxv=10 minv=5
1,MotorAccel(MOTOR_LEFT_ANKLE,3,5000,ACCEL_LEFT_FOOT,Z,0,-10,5,ACCEL_LEFT_LOWER_LEG,Z,-8,-1,0.5,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=3|MAX_REVERSE_THRUST=5|MAX_VELOCITY=10|MIN_VELOCITY=7|FUTURE_LOG|MAINTAIN_THRUST)
1,MotorAccel(MOTOR_RIGHT_ANKLE,3,5000,ACCEL_RIGHT_FOOT,Z,0,-10,5,ACCEL_LEFT_LOWER_LEG,Z,-8,-1,0.5,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=3|MAX_REVERSE_THRUST=5|MAX_VELOCITY=10|MIN_VELOCITY=7)
...
3,MotorAccel(MOTOR_LEFT_KNEE,10,230,ACCEL_TORSO,Z,-4,-2,2,WAIT_STAGE|HOLD_ANGLE=1:1|MAX_THRUST=16|MAX_REVERSE_THRUST=6|MAINTAIN_THRUST|ABORT_ANGLE0=25)
...
4,MotorAccel(MOTOR_LEFT_FOOT,10,230,ACCEL_LEFT_FOOT,X,0,-5,5,ACCEL_TORSO,X,TX0,-2,2,WAIT_STAGE|HOLD_ANGLE=2:0.5|MAX_THRUST=16|MAX_REVERSE_THRUST=3|MAX_VELOCITY=20)
