...
2,MotorAccel(MOTOR_LEFT_SIDE,4,4000,ACCEL_LEFT_LOWER_LEG,Z,-7,-1.5,1,ACCEL_TORSO,Z,-5,-1,1,WAIT_STAGE|MAX_THRUST0=4|MAX_REVERSE_THRUST0=4|MIN_VELOCITY0=5|MAX_VELOCITY0=8|MAX_THRUST1=7|MAX_REVERSE_THRUST1=4|MIN_VELOCITY1=20|MAX_VELOCITY1=40|MAX_ACCEL0=0.1|MAX_ACCEL1=5|FUTURE_LOG|NO_STOP_ON_TARGET|ABORT_ON_TIMEOUT)
#important note: right side motor picks up momentum in stage 2, but needs to reverse for right leg lift (stage 3), 
2,MotorAccel(MOTOR_RIGHT_SIDE,4,4000,ACCEL_LEFT_LOWER_LEG,Z,-7,-1.5,1,ACCEL_TORSO,Z,-5,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST0=4|MAX_REVERSE_THRUST0=4|MIN_VELOCITY0=5|MAX_VELOCITY0=8|MAX_THRUST1=7|MAX_REVERSE_THRUST1=4|MIN_VELOCITY1=20|MAX_VELOCITY1=40|MAX_ACCEL0=0.1|MAX_ACCEL1=5|NO_STOP_ON_TARGET)
#|NO_STOP_ON_TARGET
...
3,MotorAccel(MOTOR_RIGHT_LEG,20,600,ACCEL_RIGHT_UPPER_LEG,X,16,-1,5,WAIT_STAGE|CONSTANT_THRUST)
3,MotorAccel(MOTOR_LEFT_LEG,20,600,ACCEL_RIGHT_UPPER_LEG,X,16,-1,5,WAIT_STAGE|CONSTANT_THRUST|HOLD_ANGLE)
...
3,MotorAccel(MOTOR_LEFT_ANKLE,12,600,ACCEL_LEFT_FOOT,Z,0,-10,10,ACCEL_LEFT_LOWER_LEG,Z,-7.5,-1,0.5,WAIT_STAGE|HOLD_ANGLE=20.0:2.0|MAX_THRUST=20|MAX_REVERSE_THRUST=2|MAX_VELOCITY=5|MAINTAIN_THRUST|ABORT_ANGLE0=30|FUTURE_LOG)
#right ankle needs to repeat stage 2 inst because the right foot is still on the ground for a long time in stage 3
3,MotorAccel(MOTOR_RIGHT_ANKLE,3,600,ACCEL_RIGHT_FOOT,Z,0,-10,5,ACCEL_LEFT_LOWER_LEG,Z,-7.5,-1,0.5,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=20|MAX_REVERSE_THRUST=2|MAX_VELOCITY=5)
...
3,MotorAccel(MOTOR_RIGHT_SIDE,20,600,ACCEL_RIGHT_UPPER_LEG,Z,-10,-1,1,WAIT_STAGE|HOLD_ANGLE=20:0|MAX_THRUST=5|MAX_REVERSE_THRUST=2|MIN_VELOCITY=5|MAX_VELOCITY=40|MAX_ACCEL=1.0|MAINTAIN_THRUST)
...
4,TouchSensor(TOUCH_RIGHT_FOOT_FRONT,GT,3,400)
4,TouchSensor(TOUCH_RIGHT_FOOT_BACK,GT,3,400)
4,MotorAccel(MOTOR_RIGHT_LEG,12,400,ACCEL_RIGHT_UPPER_LEG,X,RULX0,-1,1,WAIT_STAGE|CONSTANT_THRUST)
4,MotorAccel(MOTOR_LEFT_LEG,12,400,ACCEL_RIGHT_UPPER_LEG,X,RULX0,-1,1,WAIT_STAGE|HOLD_ANGLE|MAX_THRUST=18|MAX_REVERSE_THRUST=3|CONSTANT_THRUST)
...
#was -12
4,MotorAccel(MOTOR_RIGHT_SIDE,10,400,ACCEL_RIGHT_UPPER_LEG,Z,-6,-1,1,WAIT_STAGE|HOLD_ANGLE=10:0|MAX_THRUST=14|MAX_REVERSE_THRUST=2)
...
4,MotorAccel(MOTOR_RIGHT_ANKLE,10,400,ACCEL_RIGHT_FOOT,Z,0,-2,2,WAIT_STAGE|HOLD_ANGLE=1:1|MAX_THRUST=12|MAX_REVERSE_THRUST=6)
...
5,MotorAccel(MOTOR_RIGHT_KNEE,8,3000,ACCEL_HIP,Z,0,-1,1,ACCEL_RIGHT_UPPER_LEG,X,RULX0,-1,1,WAIT_STAGE|HOLD_ANGLE=0.5:0.5|MAX_THRUST0=5|MAX_REVERSE_THRUST0=5|MAX_THRUST1=6|MAX_REVERSE_THRUST1=6|MAX_VELOCITY0=10|MAX_VELOCITY=10|MAX_ACCEL=1.0|ABORT_ANGLE0=40)  
...
5,MotorAccel(MOTOR_LEFT_KNEE,8,3000,ACCEL_HIP,Z,0,-1,1,ACCEL_LEFT_UPPER_LEG,X,LULX0,-1,1,WAIT_STAGE|HOLD_ANGLE=0.5:0.5|MAX_THRUST0=5|MAX_REVERSE_THRUST0=5|MAX_THRUST1=6|MAX_REVERSE_THRUST1=6|MAX_VELOCITY0=10|MAX_VELOCITY1=10|MAX_ACCEL=1.0|FUTURE_LOG)
5,MotorAccel(MOTOR_LEFT_ANKLE,3,3000,ACCEL_LEFT_FOOT,Z,0,-10,10,ACCEL_LEFT_UPPER_LEG,Z,LULZ0,-1,3,WAIT_STAGE|HOLD_ANGLE=0.5:1|MAX_THRUST=6|MAX_REVERSE_THRUST=3|MAX_ACCEL=0.1|MAX_VELOCITY=20|MIN_VELOCITY=5|FUTURE_LOG|ABORT_ANGLE0=30)
5,MotorAccel(MOTOR_RIGHT_ANKLE,3,3000,ACCEL_RIGHT_FOOT,Z,0,-10,10,ACCEL_RIGHT_UPPER_LEG,Z,RULZ0,-1,3,WAIT_STAGE|HOLD_ANGLE=0.5:0.5|MAX_THRUST=6|MAX_REVERSE_THRUST=3|MAX_ACCEL=0.1|ABORT_ANGLE0=30)
