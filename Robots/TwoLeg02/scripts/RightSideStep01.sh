...
#1,MotorAccel(MOTOR_LEFT_SIDE,MOTOR_RIGHT_SIDE,3,5000,ACCEL_LEFT_LOWER_LEG,Z,-3,-1,1,WAIT_STAGE|DOUBLE_THRUST|FUTURE_LOG|CONSTANT_THRUST)
#1,MotorAccel(MOTOR_LEFT_ANKLE,7,5000,ACCEL_LEFT_FOOT,Z,0,-3,3,ACCEL_LEFT_LOWER_LEG,Z,-3,-1,1,WAIT_STAGE|DOUBLE_THRUST|FUTURE_LOG|CONSTANT_THRUST)
#1,MotorAccel(MOTOR_RIGHT_ANKLE,7,5000,ACCEL_RIGHT_FOOT,Z,0,-3,3,ACCEL_LEFT_LOWER_LEG,Z,-3,-1,1,WAIT_STAGE|DOUBLE_THRUST|FUTURE_LOG|CONSTANT_THRUST)
...
#Stage 2: push right leg to left
#(LEFT FOOT MOTOR HOLDS ROBOT FROM FALLING FORWARD)
#2,MotorAccel(MOTOR_RIGHT_SIDE,9,2000,ACCEL_RIGHT_UPPER_LEG,Z,-11,-1,1,WAIT_STAGE|HOLD_ANGLE|CONSTANT_THRUST)
#important that left side motor must counter
#2,MotorAccel(MOTOR_LEFT_SIDE,9,2000,ACCEL_RIGHT_UPPER_LEG,Z,-11,-1,1,WAIT_STAGE|HOLD_ANGLE|CONSTANT_THRUST)

2,TurnMotor(MOTOR_RIGHT_SIDE,-9,1000)
2,TurnMotor(MOTOR_LEFT_SIDE,9,1000)
#2,MotorAccel(MOTOR_RIGHT_LEG,9,1000,ACCEL_RIGHT_UPPER_LEG,X,25,-0.5,0.5,WAIT_STAGE|CONSTANT_THRUST)
#2,MotorAccel(MOTOR_LEFT_LEG,9,1000,ACCEL_RIGHT_UPPER_LEG,X,25,-0.5,0.5,WAIT_STAGE|CONSTANT_THRUST|HOLD_ANGLE)
...
#2,MotorAccel(MOTOR_RIGHT_SIDE,6,1000,ACCEL_RIGHT_UPPER_LEG,Z,-9,-1,1,WAIT_STAGE|HOLD_ANGLE)

#left foot holds robot weight from falling forward. inst lasts through final stage ABORT_ANGLE1=35 
#2,MotorAccel(MOTOR_LEFT_FOOT,1,6100,ACCEL_LEFT_FOOT,X,0,-5,5,ACCEL_LEFT_LOWER_LEG,X,CurrentAngle[LLLX],-1,1,WAIT_STAGE|HOLD_ANGLE|LAST_STAGE=16|FUTURE_LOG|ABORT_ANGLE1=35)
